...
pub const BlockIndex = struct {
    ...
    pub fn put_block(self: *BlockIndex, block: ContextBlock) !void {
        ...
        // Large blocks use chunked copying to improve cache locality
    ...
    /// Returns block if found and not tombstoned.
    ...
    /// Removes block and updates memory accounting.
    ...
    /// Adds tombstone and removes existing block if present.
    ...
    /// Validates all invariants in debug builds (zero-cost in release).
