...
test "scenario: monolithic deep call chains with realistic workload" {
    ...
    // Capture initial metrics before generating any data
    ...
    // Note: Metrics comparison removed as it's timing-dependent and flaky
    // The important properties are verified by check_no_data_loss and check_memory_bounds
